...
public class executable extends JFrame {
    ...
    public executable() {
        ...
        // Se agrega try-catch aquí porque el constructor de dashboard lanza Exception
        try {
            ...
            System.err.println("Error al iniciar el dashboard: " + e.getMessage());
        }
    ...
    public void mostrarVista(String nombre) {
        // Buscamos y eliminamos la vista anterior para que se refresquen los datos de la DB
        ...
        // Se agrega try-catch aquí para capturar errores de la base de datos al crear las vistas
        try {
            ...
            System.err.println("Error al cargar la vista " + nombre + ": " + e.getMessage());
            e.printStackTrace();
        }
